    ...
    if (block.type === 'tweet') {
        ...
        if (
            ...
            content = (
                ...
                <video playsInline controls preload="metadata" style={assetStyle} src={source} title={block.type} />
            );
        } else {
            ...
            if (src) {
                ...
                if (youtubeVideoId) {
                    content = (
                        <LiteYouTubeEmbed id={youtubeVideoId} style={assetStyle} className="notion-asset-object-fit" />
                    );
