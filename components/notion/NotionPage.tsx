...
import { NotionRenderer } from '@/components/renderer/renderer';
import { Code } from '@/components/renderer/third-party/code';
import { Collection } from '@/components/renderer/third-party/collection';
import { Equation } from '@/components/renderer/third-party/equation';
import { Modal } from '@/components/renderer/third-party/modal';
import { Pdf } from '@/components/renderer/third-party/pdf';
import { formatDate } from '@/components/renderer/utils/format-date';
import { getBlockTitle } from '@/components/renderer/utils/get-block-title';
import { getPageProperty } from '@/components/renderer/utils/get-page-property';
...
export const NotionPage: React.FC<Required<types.PageProps & any>> = ({ site, recordMap, error, pageId, ...rest }) => {
